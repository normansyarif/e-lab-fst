...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Daftar Pengajuan ke Dekan</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <a href="{{ route('gudang.kelola.buat-pengajuan') }}" class="btn btn-primary float-right add-btn-table"><span class="fa fa-plus"></span></a>
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Mengunggu konfirmasi lab {{ $ajuan->teraju->nama }}</td>
              <td></td>
              @elseif($ajuan->status == 4)
              <td>Mengunggu validasi lab {{ $ajuan->teraju->nama }}</td>
              <td></td>
              ...
              @if($ajuan->id_teraju == 0)
              <td>
                <a title="Cetak surat pengajuan ke dekanat" href="{{ route('print.surat.pengajuan', $ajuan->id) }}" class="btn btn-success btn-sm">Cetak surat</a>
                <p class="btn-text-info">(Diserahkan ke dekanat)</p>
              </td>
              @else
              <td>
                <a title="Lihat surat terima" href="#" class="btn btn-success btn-sm">Surat terima</a>
                <p class="btn-text-info">(Diserahkan ke dekanat)</p>
              </td>
              @endif
